                    ...
                    foreach (string element in arrTable)
                    {
                        ...
                        if (arrSubElements.Length > 0)
                        {
                            for (int i = 0; i <= arrSubElements.Length-1; i++)
                            {
                                ...
                                {
                                    case 0:
                                        model.Id = arrSubElements[i];
                                        break;
                                    case 1:
                                        model.FullName = arrSubElements[i];
                                        break;
                                    default:
                                        break;
                                }
                            ...
                            for (int i = 0; i <= arrSubElements.Length - 1; i++)
                            {
                                switch (i)
                                {
                                    case 0:
                                        ...
                                        break;
                                    case 1:
                                        model.ToyName = arrSubElements[i];
                                        break;
                                    case 2:
                                        if (model02List.Count() > 0)
                                        {
                                            List<Table01Model> tempModel = new List<Table01Model>();
                                            foreach (Table01Model modelItem in model02List)
                                            {
                                                if (arrSubElements[i] == modelItem.Id)
                                                {
